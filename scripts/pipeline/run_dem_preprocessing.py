#!/usr/bin/env python3
"""CLI entry point for Step 01 – DEM preprocessing."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Step 01 of the Upper Truckee ten-step pipeline: DEM preprocessing.",
    )
    parser.add_argument(
        "--config",
        type=Path,
...
def main() -> None:
    args = parse_args()
    outputs = run_step01_dem_preprocessing(args.config)
