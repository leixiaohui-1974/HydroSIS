...
def _RichDEMVersion():
  """Get RichDEM version info (local bundled version 0.3.4)"""
  if _richdem is None:
    return "RichDEM (Python 0.3.4-local) (bundled)"
  return "RichDEM (Python 0.3.4-local) (hash={hash}, hashdate={compdate})".format(
